...
const pass_copy = document.getElementById('pass_copy');
...
function copyPassword() {
	let copyText = document.getElementById("passLenght");
	copyText.select();
...
pass_start.addEventListener('click', () => { passLenght.value = generatePassword()});
pass_copy.addEventListener('click', () => {copyPassword()});
